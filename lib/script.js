...
document.getElementById("registerModalBtn")?.addEventListener("click", () => registerForm.slideTo(0));
document.getElementById("backToRegister")?.addEventListener("click", () => registerForm.slideTo(0));